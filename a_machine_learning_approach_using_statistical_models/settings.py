...
ROOT_URLCONF = 'a_machine_learning_approach_using_statistical_models.urls'
...
WSGI_APPLICATION = 'a_machine_learning_approach_using_statistical_models.wsgi.application'
